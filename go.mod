...
require (
	...
	github.com/rakunlabs/ada v0.1.5
	...
	github.com/rakunlabs/ada/middleware/recover v0.1.0
	github.com/rakunlabs/ada/middleware/requestid v0.1.0
...
require (
	...
	github.com/worldline-go/klient v0.9.11 // indirect
